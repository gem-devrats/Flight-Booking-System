...
export class HardCodedFlightDataService {
  ...
  constructor() { 
    ...
    this.flightData.push(new Flight(4,'https://th.bing.com/th/id/OIP.UYRukWfiC6TpT9SjDNLeRAHaEq?pid=ImgDet&rs=1','SpiceJet','Mumbai, India','BOM','New Delhi, India','DEL','14:00','2h 30m',1976,6543,'11:20'));
  }
